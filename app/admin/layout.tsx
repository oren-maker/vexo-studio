...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const NAV: Array<{ href: string; label: string; section?: string }> = [
    ...
    { href: "/admin/users", label: t("nav.users"), section: t("section.workspace") },
    { href: "/admin/roles", label: t("nav.roles") },
    { href: "/admin/providers", label: t("nav.providers") },
    { href: "/admin/wallets", label: t("nav.wallets") },
    { href: "/projects", label: t("nav.projects"), section: t("section.content") },
    { href: "/templates", label: t("nav.templates") },
    { href: "/admin/notifications", label: t("nav.notifications"), section: t("section.platform") },
    { href: "/admin/api-keys", label: t("nav.api.keys") },
    { href: "/admin/webhooks", label: t("nav.webhooks") },
    { href: "/admin/logs", label: t("nav.audit.logs") },
    { href: "/account/sessions", label: t("nav.sessions"), section: t("section.account") },
    { href: "/account/2fa", label: t("nav.2fa") },
  ];
