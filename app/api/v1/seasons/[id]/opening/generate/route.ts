...
export async function POST(req: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    // Pull character reference portraits for identity lock (nano-banana and fal
    // video models both accept image_urls). Use the front-angle for each chosen cast member.
